...
public class HttpRequest {
	 ...
	 *            the proxy
	 */
	public HttpRequest(final URL url, final String requestMethod, final Proxy proxy) {
		this.url = url;
	 ...
	 */
	public HttpRequest(final String url, final String requestMethod) throws MalformedURLException {
